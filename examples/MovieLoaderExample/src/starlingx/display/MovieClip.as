...
//        trace(">>>", numFrames);
    ...
    {
        var map: Object = {};
        for (var j: int = 0; j < this.numFrames; j++) {
            map[j] = {start: _frames[j].startTime}
        }
        ...
        for (var i:int=1; i<numFrames; ++i)
        {
            ...
            if (!MathUtil.isEquivalent(prevFrame.startTime,  map[i].start, 0.000000001)) {
//                enterDebugger();
...
class MovieClipFrame
{
    ...
    public function toString(): String {
        return "[MovieClipFrame(texture="+texture+", duration="+duration+",  startTime="+startTime+")]";
    }
}